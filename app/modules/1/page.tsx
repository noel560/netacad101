...
const temak: Tema[] = [
  {
    slug: "1-0",
    title: "1.0. A hálózatok hatása az életünkre",
    shortDesc: "Megmutatjuk, hogy a hálózatok miként befolyásolják a mindennapi életünket.",
  },
  {
    slug: "1-1",
    title: "1.1. A hálózat részei",
    shortDesc: "Elmagyarázzuk az állomások és hálózati eszközök szerepét.",
  },
  {
    slug: "1-2",
    title: "1.2. A halózatok megjelenítése és a topológiák",
    shortDesc: "Megmutatjuk a hálózatok ábrázolását és azt, hogy a hálózati topológiákban ez miként használható.",
  },
  {
    slug: "1-3",
    title: "1.3. Gyakori hálózattípusok",
    shortDesc: "Összehasonlítjuk a hálózatok leggyakoribb fajtáinak jellemzőit.",
    off: true,
  },
  {
    slug: "1-4",
    title: "1.4. Internetkapcsolat",
    shortDesc: "Megnézzük, hogy a LAN-ok és WAN-ok miként kapcsolódnak az internethez.",
    off: true,
  },
  {
    slug: "1-5",
    title: "1.5. Megbízható hálózatok",
    shortDesc: "Megtanuljuk a megbízható hálózatok négy alapkövetelményét.",
    off: true,
  },
  {
    slug: "1-6",
    title: "1.6. Halózati trendek",
    shortDesc: "Megnézzük azt, hogy a BYOD, az online együttműködés, a videók és a felhőalapú számítástechnika hogyan változtatja meg a kommunikációs szokásainkat.",
    off: true,
  },
  {
    slug: "1-7",
    title: "1.7. Hálózatbiztonság",
    shortDesc: "Megnézünk néhány alapvető hálózati biztonsági fenyegetést és azok megoldásait.",
    off: true,
  },
  {
    slug: "1-8",
    title: "1.8. Az IT szakértő",
    shortDesc: "Megnézzük a hálózattal kapcsolatos informatikai álláslehetőségeket.",
    off: true,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 md:py-16">
        ...
        <div className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 text-gray-800 dark:text-gray-100">
            A hálózat fogalma, típusai és alapvető felépítése a mai világban
          </h2>
