...
const temak: Tema[] = [
  {
    slug: "6-0",
    title: "6.0. Az adatkapcsolati rétegcélja",
    shortDesc: "Az adatkapcsolati réteg céljának és funkciójának bemutatása a kommunikáció előkészítésében egy adott adathordozón történő továbbítás esetén.",
    off: true
  },
  {
    slug: "6-1",
    title: "6.1. Topológiák",
    shortDesc: "WAN és LAN topológiákban használt közeghozzáférés-vezérlési módszerek jellemzőinek összehasonlítása.",
    off: true
  },
  {
    slug: "6-2",
    title: "6.2. Adatkapcsolati keret",
    shortDesc: "Az adatkapcsolati keret jellemzőinek és funkcióinak bemutatása.",
    off: true
  }
];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 md:py-16">
        ...
        <div className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 text-gray-800 dark:text-gray-100">
            Adatkapcsolati réteg: keretek, MAC-címek és hibajavítás alapjai
          </h2>
